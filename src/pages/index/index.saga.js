...
import { fetchInstance } from '../../utilities/fetch';
...
export function* socketMainConnect({ payload }) {
  ...
  try {
    ...
    if (IS_OFFLINE_VERSION) {
      ...
      const { data: _data, error, errorCode, errorMsg } = yield call(fetchInstance.request, { method: 'post', url: '/device/registerOne', data: payload });
